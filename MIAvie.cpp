...
int main(){
  ...
  //---------------------- agregando algunas series -----------------------------
    // Series
    miavieplus.agrega_serie("Demon slayer","Tanjirou Kamado es un chico inteligente y de buen corazón "
                            "que vive con su familia y gana dinero vendiendo carbón. Todo cambia cuando "
                            "su familia es atacada y asesinada por un demonio (oni).","B");
    ...
    miavieplus.agrega_serie("La casa de papel","Ocho ladrones toman rehenes en la Fábrica "
                             "Nacional de Moneda y Timbre de España, mientras el líder de la "
                             "banda manipula a la policía para cumplir con su plan.","TV-MA");
    ...
    miavieplus.agrega_serie("BRIDGERTON","Mientras las debutantes anhelan ser los diamantes "
                             "más relucientes del baile, una discreta gema con una doble vida "
                             "descubre su propio brillo entre secretos y sorpresas.","TV-MA");
    ...
    miavieplus.agrega_serie("SPY x FAMILY","Loid y Yor son un par de espías con una doble vida,"
                             "manteniendo sus identidades ocultas incluso entre ellos mismos"
                             "mientras simulan ser la familia ideal. Sin embargo, su hija adoptiva "
                             "Anya, dotada de habilidades telepáticas, conoce sus secretos más profundos "
    ...
    // Peliculas
    miavieplus.agrega_pelicula("LALALAND","Este musical explora la alegria y el dolor de "
                                "perseguir los sueños por medio de la historia de Mia, una "
                                "aspirante a actriz y Sebastian, un musico de jazz, quienes "
                                "luchan por sobrevivir en Los Angeles, una ciudad conocida "
                                "por aplastar las esperanzas.","PG-13","02:07:52");

    miavieplus.agrega_pelicula("Madagascar","Cuatro amigos animales prueban la vida salvaje "
                                "cuando, luego de espacar de su cautiverio en el zoologico de "
                                "Central Park, van a parar a la orilla de la isla de Madagascar","PG","01:26:26");


    miavieplus.agrega_pelicula("Una pelicula de huevos","Un huevito llamado Toto suena con "
                                "llegar a ser un pollo, para lo que debe escaparse con otro "
                                "huevo y una tira de tocino despues de ser vendidos en un "
                                "supermercado.","TV-PG","01:29:50");
